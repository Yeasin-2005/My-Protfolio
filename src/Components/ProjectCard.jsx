...
const ProjectCard = ({ ImgSrc, ProjectName,className }) => {
    return (
        <>
            <div className={`${className} bg-secondary p-5 rounded-2xl w-82 transition-transform duration-300 ease-out  hover:scale-110 timeline-view animate-blurred-fade-in animate-range-[entry_10%_contain_30%]`}>
